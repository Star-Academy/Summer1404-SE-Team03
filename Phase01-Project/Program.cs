...
namespace Phase01_Project 
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            // Basic check to ensure data was loaded successfully.
            ...
            foreach (var studentInfo in topThreeStudents)
            {
                ...
                // The :F2 format specifier ensures the average score is displayed with exactly two decimal places.
                Console.WriteLine($"Average Grade: {studentInfo.AverageScore:F2}");
                Console.WriteLine("----------------------------------");
            }

            Console.WriteLine("\nOperation completed successfully. Press any key to exit.");
            Console.ReadKey(); // Keeps the console window open until a key is pressed by the user.
        }
    }
}